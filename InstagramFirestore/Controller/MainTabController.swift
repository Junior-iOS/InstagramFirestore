...
class MainTabController: UITabBarController {
    ...
    func configureViewControllers() {
        ...
        let profile = templateNavigationController(unselectedImage: #imageLiteral(resourceName: "profile_unselected"), selectedImage: #imageLiteral(resourceName: "profile_selected"), rootViewController: ProfileViewController(collectionViewLayout: headerLayout))
